...
const sacerdote = new Protagonista(image = "sacerdote.png", arma = espada, miArea = new AreaImagen(ancho = 1, alto = 5), posicionArmaX = 2, posicionArmaY = 2,barraVida=vidaPersonajePrincipal)//
/* 
